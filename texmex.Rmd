...
```{r threshStabPlots, echo = TRUE, cache = TRUE, fig.cap = "Threshold stability plots for adjusted scale (left) and shape parameter (right) for the Fort Collins daily cumulated precipitation."}
thstab <- 
  with(FortCollins,
     texmex::gpdRangeFit(
       data = precip,
